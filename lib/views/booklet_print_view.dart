          ...
          return [
            ...
            if (divisionData.standings.isNotEmpty) ...[
              ...
              pw.Table(
                ...
                columnWidths: const {
                  0: pw.FixedColumnWidth(22),  // Pos
                  1: pw.FlexColumnWidth(4),    // Club
                  2: pw.FixedColumnWidth(22),  // P
                  3: pw.FixedColumnWidth(22),  // W
                  4: pw.FixedColumnWidth(22),  // D
                  5: pw.FixedColumnWidth(22),  // L
                  6: pw.FixedColumnWidth(26),  // PF
                  7: pw.FixedColumnWidth(26),  // PA
                  8: pw.FixedColumnWidth(26),  // +/-
                  9: pw.FixedColumnWidth(22),  // TB
                  10: pw.FixedColumnWidth(22), // LB
                  11: pw.FixedColumnWidth(28), // PTS
                },
                children: [
                  // Table Header
                  pw.TableRow(
            ...
            // SECTION 2: FIXTURES & RESULTS (CONDENSED 1-LINE PER FIXTURE)
            pw.Container(
    ...
    return Container(
      ...
      child: Table(
        columnWidths: const {
          ...
          6: FixedColumnWidth(40), // PF
          7: FixedColumnWidth(40), // PA
          8: FixedColumnWidth(40), // +/-
          9: FixedColumnWidth(34), // TB
          10: FixedColumnWidth(34), // LB
          11: FixedColumnWidth(42), // Pts
        },
            ...
            return TableRow(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      _buildTeamLogo(s.teamName, s.logoUrl, size: 16),
